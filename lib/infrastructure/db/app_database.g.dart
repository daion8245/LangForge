...
class $GlossaryTermsTable extends GlossaryTerms
    with TableInfo<$GlossaryTermsTable, ProjectGlossaryTermRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<ProjectGlossaryTermRow> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ProjectGlossaryTermRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ProjectGlossaryTermRow(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
...
class ProjectGlossaryTermRow extends DataClass
    implements Insertable<ProjectGlossaryTermRow> {
  final String id;
  ...
  factory ProjectGlossaryTermRow.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  ProjectGlossaryTermRow copyWith({
    String? id,
    String? sourceTerm,
    String? targetTerm,
    String? sourceLang,
  ...
  ProjectGlossaryTermRow copyWithCompanion(GlossaryTermsCompanion data) {
    return ProjectGlossaryTermRow(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('ProjectGlossaryTermRow(')
          ..write('id: $id, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ProjectGlossaryTermRow &&
          other.id == this.id &&
...
class GlossaryTermsCompanion extends UpdateCompanion<ProjectGlossaryTermRow> {
  final Value<String> id;
  ...
  GlossaryTermsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       targetLang = Value(targetLang),
       updatedAt = Value(updatedAt);
  static Insertable<ProjectGlossaryTermRow> custom({
    Expression<String>? id,
